            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #ddd; border-collapse: collapse;">
                ...
                <tr>
                    <td style="border: 1px solid #ddd; border-collapse: collapse;">
                        <img clicktracking="off" src="{{asset('assets/images/email-temp/13.jpg')}}" alt="" width="70">
                    </td>
                    <td valign="top" style="border: 1px solid #ddd; border-collapse: collapse; padding-left: 15px;">
                        <h5 style="margin-top: 15px; color: #444; text-align: left; font-weight: 400;">Lorem ipsum dolor sit amet.</h5>
                    </td>
                    <td valign="top" style="border: 1px solid #ddd; border-collapse: collapse; padding-left: 15px;">
                        <h5 style="font-size: 14px; color:#444;margin-top: 10px; text-align: left; font-weight: 400;">QTY : <span>2</span></h5>
                    </td>
                    <td valign="top" style="border: 1px solid #ddd; border-collapse: collapse; padding-left: 15px;">
                ...
                <tr>
                    <td
                        ...
                        <p
                            ...
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad blanditiis deleniti hic quae soluta ut?
                        </p>
                    </td>

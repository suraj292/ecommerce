<header class="header-2">
                ...
                <div class="col-lg-6">
                    <div class="header-contact">
                        <ul style="margin-bottom: 0">
                            <li>Welcome to Our store HOUSE OF BHAVANA</li>
                            <li><i class="fa fa-phone" aria-hidden="true"></i>Call Us: 123 - 456 - 7890</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 text-end">
                    <ul class="header-dropdown" style="margin-bottom: 0">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="main-menu" style="border-bottom: 1px solid #dddddd4f;">
                    <div class="menu-left">
                            ...
                            <ul>
                                <li class="onhover-div mobile-search">
                                    <div><img src="{{ asset('assets/images/icon/search.png') }}" onclick="openSearch()"
                                              class="img-fluid blur-up lazyload" alt="search">
                                ...
                                <li class="onhover-div mobile-setting">
                                    <div><img src="{{ asset('assets/images/icon/setting.png') }}"
                                              class="img-fluid blur-up lazyload" alt="setting">

                            ...
                            <div class="col-lg-6 col-sm-12 col-xs-12">
                                <div class="checkout-details shadow">
                                    <div class="order-box">
                                        ...
                                        <ul class="qty">
                                            ...
                                            @foreach($cart as $product)
                                                <li class="text-capitalize">{{ $product['title'] }} × {{ $product['quantity'] }}

                                                        @if($product['offer_price'])

                                                            <span>
                                                                &#8377; {{ $price = $product['offer_price'] * $product['quantity'] }}
                                                        ...
                                                        @else
                                                            ...
                                                            <span>
                                                                &#8377; {{ $withoutOffer = $price = $product['price'] * $product['quantity'] }}
                                                            </span>
                                        ...
                                        <ul class="sub-total">
                                            @if($coupon && $costWithoutOffer * $coupon['value'] > 0)
                                                ...
                                                <li>Subtotal <span class="count">&#8377; {{ $costWithoutCoupon }}</span></li>
                                                <li style="display: none;">Subtotal <span class="count">&#8377; {{ $total = $costWithoutCoupon - $discount }}</span></li>
                                    ...
                                    <div class="payment-box">
                                        <div class="text-end">
                                            <a wire:click="placeOrder" {{--wire:click="placeOrder2"--}} class="btn-solid btn">Place Order</a>

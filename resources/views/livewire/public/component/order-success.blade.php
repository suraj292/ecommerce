            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="success-text">
                        ...
                        <p class="font-weight-bold">Order ID: {{ $order->order_number }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="product-order">
                        ...
                        <div class="row product-order-detail">
                            <div class="col-3"><img src="{{asset('storage/product/small/'.$product->image)}}" alt="" class="img-fluid blur-up lazyloaded"></div>
                            ...
                            <span style="display: none;">{{ $subtotal += $price * $product->quantity }}</span>
                        @endforeach

                        <div class="total-sec">
                            <ul>
                                <li>subtotal <span>&#8377; {{ $subtotal }}</span></li>
                                <li>Net Amount <span>&#8377; {{ round($subtotal * 100 / 118) }}</span></li>
                                <li>tax(GST) <span>&#8377; {{ $order->gst_charge }}</span></li>
                        ...
                        <div class="final-total">
                            <h3>total <span>&#8377; {{ $order->total_payable_cost }}</span></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <ul class="order-detail">
                                    ...
                                    <li>Order Total: &#8377; {{ $order->total_payable_cost }}</li>
                                </ul>
                            </div>
                            <div class="col-sm-6">
                                <h4>shipping address</h4>
                                <ul class="order-detail">
                                    <li>Name: {{ strtoupper($address->name) }}</li>
                                    <li>{{ $address->address }}, </li>
                                    <li>{{ $address->locality }}</li>
                                    <li>{{ $address->city }}, {{ $address->state }}</li>
                                    <li>India, {{ $address->pincode }}</li>
                            ...
                            <div class="col-md-12">
                                <div class="delivery-sec">
                                    ...
                                    <a href="{{ route('track-order', ['order'=>$order->id, 'product'=>\Illuminate\Support\Str::slug($cart[0]->title)]) }}">track order</a>
                                </div>
                            </div>
                        </div>
                    </div>
